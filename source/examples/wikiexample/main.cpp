...
public:
    ...
    virtual void initialize(Window & window) override
    {
        ...
        m_vertexShader.reset(Shader::fromString(GL_VERTEX_SHADER, vertexShaderCode));
        m_fragmentShader.reset(Shader::fromString(GL_FRAGMENT_SHADER, fragmentShaderCode));
